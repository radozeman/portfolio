      ...
      let observer = new IntersectionObserver((entries, observer) => {
        ...
        if(entry.isIntersecting) {
          entry.target.innerHTML += `
                ...
                <p class="line2 line"><span class="yellowcolor">&emsp; &emsp;HTML5: </span><span class="yellowcolor">'pokrocily'</span><span class="redcolor">, </span></p>
                <p class="line3 line"><span class="yellowcolor">&emsp; &emsp;CSS3: </span><span class="yellowcolor">'pokrocily'</span><span class="redcolor">, </span></p>
                <p class="line4 line"><span class="yellowcolor">&emsp; &emsp;JavaScript: </span><span class="yellowcolor">'zaklady'</span><span class="redcolor">, </span></p>
                <p class="line5 line"><span class="yellowcolor">&emsp; &emsp;Git: </span><span class="yellowcolor">'zaklady'</span><span class="redcolor">, </span></p>
                <p class="line6 line"><span class="yellowcolor">&emsp; &emsp;TailwindCSS: </span><span class="yellowcolor">'zaklady'</span><span class="redcolor">, </span></p>
